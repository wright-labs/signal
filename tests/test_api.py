...
class TestGetRunStatus:
    ...
    def test_get_run_status(self, test_client, test_api_key, run_registry, test_user_id):
    ...
    def test_get_run_status_unauthorized(self, test_client, api_key_manager, run_registry):
...
class TestGetRunMetrics:
    ...
    def test_get_run_metrics(self, test_client, test_api_key, run_registry, test_user_id):
    ...
    def test_get_run_metrics_empty(self, test_client, test_api_key, run_registry, test_user_id):
...
class TestForwardBackward:
    ...
    def test_forward_backward_success(self, test_client, test_api_key, run_registry, test_user_id, sample_batch):
    ...
    def test_forward_backward_with_accumulate(self, test_client, test_api_key, run_registry, test_user_id, sample_batch):
    ...
    def test_forward_backward_updates_metrics(self, test_client, test_api_key, run_registry, test_user_id, sample_batch):
    ...
    def test_forward_backward_unauthorized(self, test_client, api_key_manager, run_registry, sample_batch):
...
class TestOptimStep:
    ...
    def test_optim_step_success(self, test_client, test_api_key, run_registry, test_user_id):
        """Test optimizer step."""
        run_id = create_test_run(run_registry, test_user_id)
    ...
    def test_optim_step_with_custom_lr(self, test_client, test_api_key, run_registry, test_user_id):
    ...
    def test_optim_step_increments_step(self, test_client, test_api_key, run_registry, test_user_id):
...
class TestSample:
    ...
    def test_sample_success(self, test_client, test_api_key, run_registry, test_user_id, sample_prompts):
    ...
    def test_sample_with_defaults(self, test_client, test_api_key, run_registry, test_user_id):
    ...
    def test_sample_with_logprobs(self, test_client, test_api_key, run_registry, test_user_id):
...
class TestSaveState:
    ...
    def test_save_state_adapter(self, test_client, test_api_key, run_registry, test_user_id):
    ...
    def test_save_state_merged(self, test_client, test_api_key, run_registry, test_user_id):
    ...
    def test_save_state_push_to_hub(self, test_client, test_api_key, run_registry, test_user_id):
