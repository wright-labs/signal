...
class FutureStore:
    ...
    def store(self, future_id: str, modal_future: Any, metadata: Optional[Dict] = None) -> None:
    ...
    def cleanup_expired(self) -> int:
        ...
        with self._lock:
            now = datetime.utcnow()
            expired = [
                fid for fid, entry in self._futures.items()
...
def store_future(future_id: str, modal_future: Any, metadata: Optional[Dict] = None) -> None:
    """Store a Modal future."""
